...
def get_classification_prompt(data, classes_to_use):
    ...
    prompt += ("\nGive a detailed description of the image and predict which group it belongs to." 
                " Answer with Group A, Group B, Group C, Group D, Group E, or Group F.")
    return prompt
...
user_note = 'multiclass detailed classification'  # User-defined note for the CSV
