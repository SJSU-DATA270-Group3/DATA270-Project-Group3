...
def get_classification_prompt(data, classes_to_use):
    ...
    prompt += "\nWhat group does this image belong to? Answer with Group A, Group B, Group C, Group D, Group E, or Group F."
    return prompt
...
user_note = 'multiclass straight forward classification'  # User-defined note for the CSV
