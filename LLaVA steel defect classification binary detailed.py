...
def get_classification_prompt(data, classes_to_use):
    ...
    prompt += "\nGive a detailed description of the image and predict which group it belongs to. Group A or Group B"
    return prompt
...
test_images = json.load(open(rf'{path}\test_images_binary.json', 'r'))
classes_to_use = ['scratches', 'patches']  # List of classes for testing
user_note = 'binary detailed classification'  # User-defined note for the CSV
